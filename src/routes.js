...
const Invitations = React.lazy(() => import('./views/users/Invitations'));
const Reports = React.lazy(() => import('./views/reports/Reports'));
{/* <Route exact path="/inviteUsers" name="InviteUsers Page" render={props => <InviteUsers {...props}/>} /> */}
...
const routes = [
  ...
  { path: '/inviteUsers', exact: true,  name: 'InviteUsers', component: InviteUsers },
